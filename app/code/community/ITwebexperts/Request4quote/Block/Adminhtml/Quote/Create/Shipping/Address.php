 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Address
    extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Form_Address
{
    ...
    {
        return Mage::helper('request4quote')->__('Shipping Address');
    }
    ...
    {
        return $this->getModuleHelper()->canShowShippingAddressAdmin();
    }
    ...
    {
        return $this->getModuleHelper()->isShippingAddressRequiredAdmin();
    }
    ...
    protected function _toHtml()
    {
        ...
        if (!$this->isRequired()) {
            ...
            $html = str_replace('order-shipping_address_postcode', 'shipping_address_postcode', $html);
        }
        */
        return $html;
    }
