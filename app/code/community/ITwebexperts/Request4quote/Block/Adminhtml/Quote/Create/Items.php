...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Items extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    /**
    ...
    {
        return Mage::helper('request4quote')->__('Items Ordered');
    }
