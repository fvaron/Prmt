 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Form_Account extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Form_Abstract
{
    /**
    ...
    {
        return Mage::helper('request4quote')->__('Account Information');
    }
    ...
    public function getFormValues()
    {
        ...
        foreach ($this->getQuote()->getData() as $key => $value) {
            if (strpos($key, 'customer_') === 0 && !is_null($value)) {
