...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $confirm = Mage::helper('request4quote')->__('Are you sure you want to cancel this order?');
