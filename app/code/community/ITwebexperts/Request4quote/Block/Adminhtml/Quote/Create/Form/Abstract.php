 ...
 */
abstract class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Form_Abstract
    extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    ...
    protected function _addAttributesToForm($attributes, Varien_Data_Form_Abstract $form)
    {
        ...
        foreach ($attributes as $attribute) {
            ...
            $attribute->setStoreId(Mage::getSingleton('request4quote/adminhtml_session_quote')->getStoreId());
