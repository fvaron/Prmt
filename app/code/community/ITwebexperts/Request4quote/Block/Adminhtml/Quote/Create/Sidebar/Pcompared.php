...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Sidebar_Pcompared extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Sidebar_Abstract
{
    ...
    {
        return Mage::helper('request4quote')->__('Recently Compared Products');
    }
