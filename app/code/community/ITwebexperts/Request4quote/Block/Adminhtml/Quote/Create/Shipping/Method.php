...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Method extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    ...
    {
        return Mage::helper('request4quote')->__('Shipping Method');
    }
