...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Totals extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    protected $_totalRenderers;
    protected $_defaultRenderer = 'request4quote/adminhtml_quote_create_totals_default';
    ...
    {
        return Mage::helper('request4quote')->__('Order Totals');
    }
