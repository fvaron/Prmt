...
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Sidebar extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    protected function _prepareLayout()
    {
        if ($this->getCustomerId()) {
            $button = $this->getLayout()->createBlock('adminhtml/widget_button')->setData(array(
                'label' => Mage::helper('request4quote')->__('Update Changes'),
