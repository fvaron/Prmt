 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Search_Grid_Renderer_Product extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Text
{
    /**
    ...
    public function render(Varien_Object $row)
    {
        ...
        return sprintf('<a href="javascript:void(0)" %s class="f-right" %s>%s</a>',
            $style, $prodAttributes, Mage::helper('request4quote')->__('Configure')) . $rendered;
    }
}
