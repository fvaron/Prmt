 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Customer_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('name', array(
            'header'    =>Mage::helper('request4quote')->__('Name'),
            'index'     =>'name'
        ));
        ...
        $this->addColumn('Telephone', array(
            'header'    =>Mage::helper('request4quote')->__('Telephone'),
            'width'     =>'100px',
            'index'     =>'billing_telephone'
        ));
        $this->addColumn('billing_postcode', array(
            'header'    =>Mage::helper('request4quote')->__('ZIP/Post Code'),
            'width'     =>'120px',
        ...
        $this->addColumn('store_name', array(
            'header'    =>Mage::helper('request4quote')->__('Signed Up From'),
            'align'     => 'center',
            'index'     =>'store_name',
            'width'     =>'130px',
        ));
