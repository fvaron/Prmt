...
if(Mage::helper('request4quote')->hasAdminShipping()){
    class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Method_Form_Common extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract{
    ...
    class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Method_Form_Common
        extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract{
 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Method_Form
    extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Shipping_Method_Form_Common
{
    protected $_rates;
