 ...
 */
class ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Giftmessage extends ITwebexperts_Request4quote_Block_Adminhtml_Quote_Create_Abstract
{
    /**
    ...
    public function getFormHtml(Varien_Object $entity, $entityType='quote') {
        return $this->getLayout()->createBlock(
                    'request4quote/adminhtml_quote_create_giftmessage_form'
