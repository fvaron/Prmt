 ...
 */
class ITwebexperts_Request4quote_Block_Checkout_Quote_Sidebar extends ITwebexperts_Request4quote_Block_Checkout_Quote_Miniquote
{
    ...
    {
        parent::__construct();
        $this->addItemRender('default', 'request4quote/quote_item_renderer', 'request4quote/cart/sidebar/default.phtml');
    }
