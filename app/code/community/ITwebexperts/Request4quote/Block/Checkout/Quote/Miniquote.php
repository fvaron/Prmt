 ...
 */
class ITwebexperts_Request4quote_Block_Checkout_Quote_Miniquote extends Mage_Checkout_Block_Cart_Abstract
{
...
//        }
        return Mage::getSingleton('request4quote/cart')->getSummaryQty();
    }
