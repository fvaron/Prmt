 ...
 */
class ITwebexperts_Request4quote_Block_Checkout_Quote_Item_Renderer extends Mage_Core_Block_Template
{
    ...
    public function getAjaxDeleteUrl(){
        return $this->getUrl(
            'request4quote_front/quote/ajaxDelete',
            array(
                'id'=>$this->getItem()->getId(),
                Mage_Core_Controller_Front_Action::PARAM_NAME_URL_ENCODED => $this->helper('core/url')->getEncodedUrl(),
    ...
    {
        return $this->getUrl(
            'request4quote_front/quote/ajaxUpdate',
            array(
                'id'=>$this->getItem()->getId(),
                Mage_Core_Controller_Front_Action::PARAM_NAME_URL_ENCODED => $this->helper('core/url')->getEncodedUrl(),
                '_secure' => $this->_getApp()->getStore()->isCurrentlySecure(),
