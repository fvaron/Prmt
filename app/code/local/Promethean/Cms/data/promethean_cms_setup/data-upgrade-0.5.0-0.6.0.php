...
<div class="footer-sociaux">
    ...
    <span class="link">
        ...
        <a href="{{store url="rss"}}"><img src="{{skin url="images/media/blog.jpg"}}" alt="Blog" /></a>
        <a href="https://twitter.com/prointeractive_"><img src="{{skin url="images/media/twitter.jpg"}}" alt="Twitter" /></a>
    </span>
</div>
HTML;
